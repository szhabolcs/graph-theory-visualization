$(document).ready(function () {
    ...
    function addNode(top = "50%", left = "50%"){     /*Inserts new node*/
        ...
        var insertedBox = $("#container").children(".node").last();

        insertedBox.css({top: top,left: left});
