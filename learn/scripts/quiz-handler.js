            ...
            if(groupId != "language"){
                ...
                $("#"+groupId).find(".cardslider__card--index-0").append(
                    '<div class="card-overlay">'+
                        ...
                        '<div style="width: fit-content;border: 2px solid;text-align: center;margin: 0 auto;padding: 10px;border-radius: 50px;" class="cardslider__nav-start">'+quiz["language"].play+'</div>'+
                    '</div>'
                );
            }
        }
            ...
            parentCard.append(
                '<div class="card-overlay">'+
                    ...
                    '</div>'+
                        ...
                        '<div style="width: fit-content;border: 2px solid;text-align: center;margin: 0 auto;padding: 10px;border-radius: 50px;" class="cardslider__nav-next">'+quiz["language"].next+'</div>'+
                    '</div>'+
                '</div>'
            );
                ...
                parentCard.find(".card-overlay-body").slideUp(()=>{
                    parentCard.find(".card-overlay").append(
                        '<div class="question-end">'+
                            ...
                            '</div>'+
                            '<div style="width: fit-content;border: 2px solid;text-align: center;margin: 0 auto;padding: 10px;border-radius: 50px;" class="cardslider__nav-reset">'+quiz["language"].tryAgain+'</div>'+
                        '</div>'
                    );
